...
//
//    private final Map<Long, RateSheet> contractsById = new LinkedHashMap<>();
//    private Map<String, Object> contracts = Collections.emptyMap();
//
//    public RateSheet getContract(Long contractId) {
...
//    }
//
//    public Map<Long, RateSheet> getAllContractsById() {
//        return Collections.unmodifiableMap(contractsById);
//    }
//
//    public List<Charge> getChargesForWarehouse(RateSheet contract, String warehouseId) {
...
//
//        RateSheet contract = yamlMapper.convertValue(node, RateSheet.class);
//
...
//
//        RateSheet previous = contractsById.put(contract.getContractId(), contract);
//        if (previous != null) {
...
//    }
//
//    private void validateAndNormalize(RateSheet contract, Resource source) {
...
//            }
//            // Ensure bidirectional consistency for runtime usage
//            wc.setContract(contract);
//        }
//    }
//}*/